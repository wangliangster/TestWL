...
# modify by liang @ 2019.Aug.13, reduce loop earlier @line 30 and add more assert 
...
def move_by_sprial(total_step=0):
	...
	while len(coordination) <= total_step:
		for direction in (RIGHT, UP, LEFT, DOWN):
			...
			if len(coordination)>total_step:
				break
...
assert get_sprial_distance(100000) == 173
assert get_sprial_distance(2345678) == 1347

print("Congratulation! you have pass all test cases.")
